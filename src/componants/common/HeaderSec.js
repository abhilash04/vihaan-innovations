    ...
    services: {
      "Services Development": [
        ...
        },
        {
          ...
          href: "web-design-development-training",
          icon: Layout,
        },
        {
          label: "Mobile Apps Development",
          href: "mobile-app-development-training",
          icon: Smartphone,
        },
        {
          label: "Custom Application Development",
          href: "custom-application-development-training",
          icon: Code,
        },
        {
          label: "Cloud-Based Development",
          href: "cloud-based-development-training",
          icon: Cloud,
        },
        {
          label: "DevOps & Automation Development",
          href: "devops-automation-training",
          icon: Workflow,
        },
        {
          label: "Data Science & Big Data Development",
          href: "data-science-big-data-training",
          icon: Database,
        },
        {
          label: "Enterprise Software Development",
          href: "enterprise-software-development-training",
          icon: Boxes,
        },
        {
          label: "AI / ML & Automation",
          href: "ai-ml-automation-training",
          icon: Bot,
        },
        {
          label: "Maintenance & Support",
          href: "software-maintenance-support-training",
          icon: LifeBuoy,
        },
      ],
      "Digital Marketing": [
        ...
        },
        {
          ...
          href: "search-engine-marketing-training",
          icon: MonitorPlay,
        },
        {
          label: "Video Marketing",
          href: "video-marketing-training",
          icon: Film,
        },
        {
          label: "Email Marketing",
          href: "email-marketing-training",
          icon: Mail,
        },
        {
        ...
        },
        {
          ...
          href: "google-my-business-training",
          icon: MapPin,
        },
        {
          label: "Affiliate & Influencer Marketing",
          href: "affiliate-influencer-marketing-training",
          icon: Users,
        },
      ],
      "Animation & Video Services": [
        ...
        { label: "2D Animation", href: "2d-animation-training", icon: Film },
        { label: "3D Animation", href: "3d-animation-training", icon: Layers },
        {
        ...
        },
        {
          ...
          href: "motion-graphics-animation-training",
          icon: PenTool,
        },
        {
          label: "Whiteboard Animation",
          href: "whiteboard-animation-training",
          icon: Edit3,
        },
        {
