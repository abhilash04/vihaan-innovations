      ...
      <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
        <Box sx={{ textAlign: "center" }}>
          <Typography variant="h2" sx={{ fontWeight: 900, color: "#ffffff", fontSize: { xs: "28px", md: "42px" }, lineHeight: 1.2, mb: 3, fontFamily: "Fira Sans" }}>
            ...
            Business with <Box component="span" sx={{ color: "#f97316", background: "linear-gradient(90deg, #f97316, #ec4899)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Smart Solutions?</Box>
          </Typography>

          <Typography sx={{ color: "rgba(255,255,255,0.7)", fontSize: "16px", mb: 2, maxWidth: "600px", mx: "auto" }}>
            Empower your business with cutting-edge technology solutions designed to streamline operations, enhance productivity, and drive sustainable growth.
          </Typography>
