...
const PortfolioCTA = () => {
  return (
    <Box sx={{ position: "relative", bgcolor: "#0f172a", py: 8, overflow: "hidden" }}>
        ...
        >
          <Box sx={{ textAlign: "center" }}>
            ...
            <Typography sx={{ color: "#ffffff", fontSize: "18px", mb: 7, opacity: 0.9 }}>
              Let's turn your vision into a high-performing digital reality. Our experts are ready to build with you.
            </Typography>
