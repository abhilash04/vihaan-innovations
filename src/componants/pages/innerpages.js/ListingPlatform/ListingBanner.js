...
const StatRow = ({ icon: Icon, text, delay, isMobile }) => (
  <motion.div
  ...
  >
    <Box sx={{ display: "flex", alignItems: "center", gap: 2, mb: 1.5 }}>
      ...
      <Typography sx={{ color: "#444", fontSize: isMobile ? "13px" : "15px", fontWeight: 600 }}>
        {text}
      </Typography>
    </Box>
  </motion.div>
      ...
      <Container maxWidth="lg" sx={{ position: "relative", zIndex: 2 }}>
        <Grid container spacing={isMobile ? 4 : 6} alignItems="center">
          ...
          <Grid item xs={isMobile ? 12 : 6}>
            ...
            >
              <Typography variant="h1" sx={{ color: "#1a1a1a", fontWeight: 800, fontSize: isMobile ? "2rem" : "3.2rem", lineHeight: 1.1, mb: 2, textAlign: isMobile ? "center" : "left" }}>
                India’s Fast Business & Product Listings
              </Typography>

              <Typography variant="h2" sx={{ color: "#16409aff", fontWeight: 700, fontSize: isMobile ? "1.1rem" : "1.25rem", mb: 2, textAlign: isMobile ? "center" : "left" }}>
              ...
              <Typography sx={{ color: "#444", fontSize: "16px", lineHeight: 1.6, mb: 4, maxWidth: "550px", textAlign: isMobile ? "center" : "left", mx: isMobile ? "auto" : 0 }}>
        ...
        <Box sx={{ mt: 5, display: "flex", flexDirection: isMobile ? "column" : "row", gap: 2, justifyContent: 'space-between' }}>
          <StatRow icon={CheckCircleOutlineIcon} text="100+ Projects Delivered" delay={0.2} isMobile={isMobile} />
          <StatRow icon={SpeedIcon} text="Scalable & Secure Solutions" delay={0.4} isMobile={isMobile} />
          <StatRow icon={ListAltIcon} text="Custom Built for Every Industry" delay={0.6} isMobile={isMobile} />
        </Box>
      </Container>
