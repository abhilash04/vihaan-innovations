          ...
          return (
            <Grid item xs={12} sm={6} md={3} key={i}>
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: i * 0.1 }}>
                <Paper elevation={0} sx={{ p: 4, borderRadius: "20px", bgcolor: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.1)", height: "100%", textAlign: "center", transition: "all 0.3s", "&:hover": { bgcolor: "rgba(255,255,255,0.1)" } }}>
