...
const EcommerceSingleRenderAboutUs = () => {
  ...
  return (
    ...
    >
      {/* Decorative spheres — hidden on mobile to prevent overflow */}
      {!isMobile && (
        <>
        ...
        <Grid container spacing={6} alignItems="center">
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              ...
              {/* Image visible on mobile — immediately after the title */}
              {isMobile && (
                <Box
                  sx={{
                    borderRadius: "16px",
              ...
              >
                At Vihaan Innovations, we help entrepreneurs and businesses build a strong online
                presence with professionally designed websites, including powerful single vendor
                ecommerce solutions tailored to your goals.
              </Typography>
              <Typography
                variant="body1"
                sx={{
              ...
              >
                We focus on performance, user experience, and modern design to ensure your single
                vendor ecommerce website not only looks great but also converts visitors into
                customers.
              </Typography>
