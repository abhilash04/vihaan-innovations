...
const HotelCTA = () => (
  <Box sx={{ position: "relative", bgcolor: "#0f2447", py: 18, overflow: "hidden" }}>
    ...
    <Container maxWidth="md" sx={{ position: "relative", zIndex: 2, textAlign: "center" }}>
      <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}>
        <Typography variant="h2" sx={{ fontWeight: 900, color: "#ffffff", fontSize: { xs: "30px", md: "46px" }, mb: 3, lineHeight: 1.2 }}>
          ...
          <Box component="span" sx={{ color: "#d4a017" }}>Own Your Revenue.</Box>
        </Typography>
        <Typography sx={{ color: "rgba(255,255,255,0.7)", fontSize: "18px", mb: 8 }}>
          Let's build the booking platform your guests deserve — and your business needs.
        </Typography>
        ...
        <Box sx={{ display: "flex", justifyContent: "center", gap: 4 }}>
          {["See a Live Demo", "Explore Features"].map((link, i) => (
