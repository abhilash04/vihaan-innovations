    ...
    <Container maxWidth="md" sx={{ position: "relative", zIndex: 2, textAlign: "center" }}>
      <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.7 }}>
        ...
        <Button
          ...
          sx={{ background: "linear-gradient(90deg, #d4a017 0%, #b8891a 100%)", color: "#0f172a", fontWeight: 900, fontSize: "16px", px: 7, py: 2.2, borderRadius: "50px", textTransform: "none", boxShadow: "0 10px 35px rgba(212,160,23,0.4)", "&:hover": { background: "linear-gradient(90deg, #b8891a 0%, #9a7215 100%)", transform: "translateY(-3px)", boxShadow: "0 16px 45px rgba(212,160,23,0.55)" }, transition: "all 0.3s", mb: 4 }}
        >
