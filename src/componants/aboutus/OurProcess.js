  ...
  return (
    <Box sx={{ py: { xs: 8, md: 8 }, background: "#fafafa" }}>
      <Container maxWidth="lg">
        <Box component={motion.div} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} sx={{ textAlign: "center", mb: 6 }}>
            ...
            <Grid item xs={12} sm={6} md={3} key={i}>
              <Box component={motion.div} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: i * 0.1 }}>
                <Card elevation={0} sx={{
                  ...
                  <Typography sx={{ position: "absolute", top: -10, left: 24, fontSize: "48px", fontWeight: 900, color: "rgba(0, 180, 216, 0.1)", fontFamily: "'Inter', sans-serif", mt: 2, mb: 2 }}>
                    {step.num}
                  </Typography>
                  <Typography sx={{ fontFamily: "'Inter', sans-serif", fontWeight: 700, fontSize: "18px", color: "#0f172a", mt: 6, mb: 2 }}>
                    {step.title}
                  </Typography>
                  <Typography sx={{ fontFamily: "'Inter', sans-serif", fontSize: "14px", color: "#64748b", lineHeight: 1.6, mt: 2, mb: 2 }}>
                    {step.desc}
                  </Typography>
                </Card>
              </Box>
